...
_CONFIG = {
  'TAGGER_MODEL': '_cache/_models/tags_titles_0/weights/05',
...
class GetQAV2Worker(FlaskWorker):
  def __init__(self, **kwargs):
    super(GetQAV2Worker, self).__init__(**kwargs)
    return
...
if __name__ == '__main__':
  ...
  a = GetQAV2Worker(log=l, default_config=_CONFIG, verbosity_level=0)
  a._load_model()
